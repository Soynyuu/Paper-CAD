...
export default {
    ...
    translation: {
        ...
        "plateau.cesium.instructions.click": "• Click: Select single building",
        "plateau.cesium.instructions.ctrlClick": "• Ctrl+Click: Toggle multi-select",
        "plateau.cesium.instructions.clearArea": "• Click empty area: Clear selection",
        "plateau.cesium.loading": "Loading 3D Tiles...",
        "plateau.cesium.noBuildingsSelected": "No buildings selected",
        "plateau.cesium.noSelection": "Selection",
        "plateau.cesium.clickToSelectBuilding": "Click a building to select",
        "plateau.cesium.ctrlClickForMultiple": "Ctrl+Click to select multiple",
