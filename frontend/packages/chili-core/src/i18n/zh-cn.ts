...
export default {
    ...
    translation: {
        ...
        "plateau.cesium.instructions.click": "• 点击: 选择单个建筑物",
        "plateau.cesium.instructions.ctrlClick": "• Ctrl+点击: 切换多选",
        "plateau.cesium.instructions.clearArea": "• 点击空白区域: 清除选择",
        "plateau.cesium.loading": "正在加载3D Tiles...",
        "plateau.cesium.noBuildingsSelected": "未选择建筑物",
        "plateau.cesium.noSelection": "选择",
        "plateau.cesium.clickToSelectBuilding": "点击建筑物进行选择",
        "plateau.cesium.ctrlClickForMultiple": "Ctrl+点击选择多个",
