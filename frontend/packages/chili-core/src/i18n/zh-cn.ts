...
export default {
    ...
    translation: {
        ...
        "plateau.cesium.lod3": "LOD3（最高细节）",
        "plateau.cesium.lod2": "LOD2（中等细节）",
        "plateau.cesium.lod1": "LOD1（基本细节）",
        ...
        "toast.plateau.cesium.loadedLod3:{0}": "已加载 {0}（LOD3 - 最高细节）",
        "toast.plateau.cesium.loadedLod2:{0}": "已加载 {0}（LOD2 - 中等细节）",
        "toast.plateau.cesium.loadedLod1:{0}": "已加载 {0}（LOD1 - 基本细节）",
