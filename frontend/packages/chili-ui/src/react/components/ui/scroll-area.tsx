...
>(({ className, ...props }, ref) => <BaseScrollArea.Content ref={ref} className={className} {...props} />);
ScrollAreaContent.displayName = "ScrollAreaContent";

const ScrollBar = React.forwardRef<
    HTMLDivElement,
    React.ComponentPropsWithoutRef<typeof BaseScrollArea.Scrollbar>
>(({ className, ...props }, ref) => <BaseScrollArea.Scrollbar ref={ref} className={className} {...props} />);
ScrollBar.displayName = "ScrollBar";

const ScrollAreaThumb = React.forwardRef<
    HTMLDivElement,
    React.ComponentPropsWithoutRef<typeof BaseScrollArea.Thumb>
>(({ className, ...props }, ref) => <BaseScrollArea.Thumb ref={ref} className={className} {...props} />);
